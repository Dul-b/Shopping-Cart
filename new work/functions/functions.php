...
function sliderdata(){
    ...
    $get_pro = "select * from products where structure='1' order by RAND() LIMIT 0,1";
...
function getpro3(){
    ...
    $get_pro = "select * from products where structure='1' order by RAND() LIMIT 1,1";
    $run_pro = mysqli_query($con,$get_pro);
...
function getpro(){
    ...
    $get_pro = "select * from products where structure='1' order by RAND() LIMIT 0,6";
    $run_pro = mysqli_query($con,$get_pro);
...
function get_pro_cat(){
    ...
    $get_pro_cat = "select * from products where structure='1' AND prd_cat ='$cat_id' ";
...
function get_pro_brand(){
    ...
    $get_pro = "select * from products where structure ='1' AND prd_brand = '$brand_id'";
    $run_pro = mysqli_query($con,$get_pro);
...
function total_price(){
   ...
   while($pprice = mysqli_fetch_array($run_price)){
      ...
      $prod_price = "select * from products where structure ='1' AND prd_id = '$pro_id'";
...
function details(){
    ...
    $get_pro = "select * from products where structure ='1' AND prd_id = '$prod_id'";
    $run_pro = mysqli_query($con,$get_pro);
...
function Simpro2(){
    ...
    $get_pro = "select * from products where structure='1' order by RAND() LIMIT 0,3";
    $run_pro = mysqli_query($con,$get_pro);
