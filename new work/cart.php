...
<div class="span9">
	...
	<h3>  SHOPPING CART [ <small><?php total_items(); ?> Item(s) </small>]<a href="products.html" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> Continue Shopping </a></h3>	
	<hr class="soft"/>
 ...
 ?>
              ...
              <tbody>
                <tr>
                  <td> <img width="60" src="admin_area/product_images/<?php echo $product_image; ?>" alt=""/></td>
                  <td><?php echo $product_title; ?></td>
				  <td>
                  <form action="" enctype="multipart/form-data" method="post">
					<div class="input-append"><input class="span1" style="max-width:34px" placeholder="1" id="appendedInputButtons" size="16" type="text"><button class="btn" type="button"><i class="icon-minus"></i></button><button class="btn" type="button"><i class="icon-plus"></i></button><button class="btn btn-danger" type="submit" name="update_cart" value="Edit"><i class="icon-remove icon-white"></i></button>				</div>
 ...
 ?>
                ...
                <tr>
				 ...
				 <tr>
                  <td colspan="6" style="text-align:right"><strong>TOTAL (<?php echo"$&nbsp;".$total;   ?> - $0 + $0) =</strong></td>
