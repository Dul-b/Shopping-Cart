...
<div id="main_container">
  <div id="header">
    <div id="logo"> <a href="#"><img src="th (5) (Copy).jpg" alt="" border="0" width="237" height="140" /></a> </div>
  ...
  <div id="main_content">
    ...
    <div class="style1">
      <div class="style2"><B>...INSERT  PRODUCT  DETAILS   THAT  YOU  WANT  TO  SELL... </B></div>
    ...
    $cat_id = $row_cats['cat_id'];
     ...
     echo "<option value=$cat_id>$cat_tit</option>";    
           ...
           ?>
            ...
            <div class="form_row">
              <label class="contact"><strong>Product Key:</strong></label>
  ...
  <!-- end of main content -->
  <div class="footer">
    <div class="left_footer"> <img src="th (5) (Copy).jpg" alt="" width="170" height="49"/> </div>
...
if(isset($_POST['index'])){
   ...
   $insert_product = "insert into products (prd_cat,prd_brand,prd_title,prd_price,prd_desc,prd_img,prd_keyword,structure) values ('$product_cat','$product_brand','$product_title','$product_price','$product_desc','$product_image','$product_keywords','0')";
