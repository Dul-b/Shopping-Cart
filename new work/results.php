...
$get_pro = "select * from products where structure ='1' AND structure ='1' AND prd_keyword like '%$search_query%'";
...
$get_pro = "select * from products where structure ='1' AND prd_keyword like '%$search_query%'";
$run_pro = mysqli_query($con,$get_pro);
