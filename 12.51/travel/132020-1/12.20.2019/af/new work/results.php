    ...
    while($row_pro = mysqli_fetch_array($run_pro)){
		...
		<div class='row'>	  
			...
			<label class='checkbox'>
			  ...
			  <a href='results.php?addcart=$product_id' title='header=[Add to cart] body=[&nbsp;] fade=[on]'' class='btn btn-large btn-primary'> Add to <i class='icon-shopping-cart'></i></a>
			  ...
			  <div class='thumbnail'>
				...
				<div class='caption'>
				  ...
				  <p> 
				   ...
				   <h4 style='text-align:center'><a class='btn' href='details.php?pro_id=$product_id' class='prod_details'> <i class='icon-zoom-in'></i></a> <a class='btn'href='results.php?addcart=$product_id' title='header=[Add to cart] body=[&nbsp;] fade=[on]''>Add to <i class='icon-shopping-cart'></i></a> <a class='btn btn-primary' href=''>$ $product_price</a></h4>
				</div>
			  </div>
			</li>
